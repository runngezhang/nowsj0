...
if [ $# -eq 1 ]; then		# default
  ...
  chime3_data=$1
  cp $chime3_data/data/models/lm_nowsj.o3g.kn.gz $lmdir || exit 1;
  cp $chime3_data/data/models/wordlist $lmdir || exit 1;
	cp $chime3_data/data/models/lm_nowsj.o4g.kn.gz $lmdir		#optional
