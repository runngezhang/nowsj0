...
local/chime3_calc_wers_nowsj0.sh exp/tri4a_dnn_tr05_real_$enhan $enhan \
...
./local/chime3_calc_wers_smbr_nowsj0.sh exp/tri4a_dnn_tr05_real_${enhan}_smbr_i1lats ${enhan} exp/tri4a_dnn_tr05_real_${enhan}/graph_${LM} \
